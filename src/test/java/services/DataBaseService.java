...
public class DataBaseService {
    ...
    static final String PSW = "696615";
    ...
    public void executeSQL(String sql) { // для insert delete и тд
        try {
    ...
    public ResultSet executeQuery(String sql) { //для селекта - возвращает данные
        try {
